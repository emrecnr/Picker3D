...
namespace Managers
{
    public class LevelManager : MonoBehaviour
    {
        ...
        {
            CoreGameSignals.Instance.onLevelInitialize += _levelLoaderCommand.Execute(_currentLevel);
        ...
        private void OnNextLevel()
        {
            ...
            CoreGameSignals.Instance.onLevelInitializ?.Invoke(_currentLevel % totalLevelCount);
        }
